...
var moreAboutHome = function (address, distanceFromTown, hasNeighbours) {
...
function doesFriendExist(ageInText, ageInNumber) {
    if ((isNaN(ageInText) === true || isNaN(ageInNumber) === true) && typeof (ageInText) !== "string") {
        return NaN;
...
function sweetTooth(totalNoOfSweets, sweetsConsumedByKaren, sweetsConsumedInNMeters, metersToTravel) {
    ...
    if (typeof (totalNoOfSweets) !== "number" || typeof (sweetsConsumedByKaren) !== "number" ||
        ...
        var leftSweets = (totalNoOfSweets - (sweetsConsumedByKaren + (sweetsConsumedInNMeters * metersToTravel))) / 2;
        return leftSweets;
    }
